  ...
  zh: {
    ...
    sheet: {
      ...
      account: {
        title: "DooTask 账号",
        notSignedIn: "未登录",
        intro: "登录 DooTask 账号即可使用官方模型，无需自备 API Key。",
        provision: "开通试用",
        login: "登录",
        logout: "退出",
        claim: "认领账号",
        ...
        submit: "提交",
        cancel: "取消",
        privacyNote: "使用 DooTask 官方模型时，聊天内容会经由 DooTask 云端网关转发处理。",
        loginFailed: "登录失败",
  ...
  en: {
    ...
    sheet: {
      ...
      account: {
        ...
        intro: "Sign in to your DooTask account to use official models—no API key of your own required.",
        ...
        submit: "Submit",
        cancel: "Cancel",
        privacyNote: "When using DooTask official models, your chat content is relayed through the DooTask cloud gateway.",
