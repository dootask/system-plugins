  ...
  zh: {
    ...
    sheet: {
      ...
      models: {
        ...
        fetchFetched: "新获取的模型",
        fetchSearchPlaceholder: "搜索模型",
        fetchSelectedCount: "已选择",
        fetchNoResult: "无匹配模型",
      ...
      account: {
        title: "DooTask App Store 账号",
        notSignedIn: "未登录",
        intro: "登录 DooTask App Store 账号即可使用 Doo AI 模型，无需自备 API Key。",
        provision: "开通试用",
        login: "登录",
        logout: "退出",
        claim: "认领账号",
        ...
        resetPrefix: "重置",
        boundAccount: "所属账号",
        selectTitle: "该账号下有多个 AI 账号，请选择一个使用：",
        selectFallback: "AI 账号",
  ...
  en: {
    ...
    sheet: {
      ...
      models: {
        ...
        fetchSearchPlaceholder: "Search models",
        fetchSelectedCount: "Selected",
      ...
      account: {
        title: "DooTask App Store Account",
        notSignedIn: "Not signed in",
        intro: "Sign in to your DooTask App Store account to use Doo AI models—no API key of your own required.",
        ...
        selectTitle: "This account has multiple AI accounts. Pick one to use:",
        selectFallback: "AI account",
