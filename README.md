...
| `okr` | 构建镜像 | OKR 目标管理（Go + Vue3，构建 `kuaifan/doookr`；源码来自 [hitosea/dootask-okr](https://github.com/hitosea/dootask-okr)） |
| `face` | 构建镜像 | 人脸签到（Go 应用，构建 `hitosea2020/dooface`；源码来自 [innet8/doofacemark](https://github.com/innet8/doofacemark)） |
| `minder` | 构建镜像 | 思维导图（Vue 应用，构建 `kuaifan/minder`；源码来自 [kuaifan/minder](https://github.com/kuaifan/minder)） |
