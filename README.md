...
| `okr` | 纯打包 | OKR 目标管理（镜像 `kuaifan/doookr` 由上游 hitosea/dootask-okr 构建） |
...
- **okr 特例**：插件包在本仓库管理，但镜像 `kuaifan/doookr` 仍由上游 [hitosea/dootask-okr](https://github.com/hitosea/dootask-okr) 构建——出新版要先在上游构建好镜像，再来本仓库加版本目录并发布。
